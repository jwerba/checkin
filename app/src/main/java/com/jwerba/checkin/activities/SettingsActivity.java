...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("pref_user_display"));
            bindPreferenceSummaryToValue(findPreference("pref_user_ssid"));
            bindPreferenceSummaryToValue(findPreference("pref_user_preferred_socialnetwork"));
        }
